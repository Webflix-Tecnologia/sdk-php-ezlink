...
class EzlinkException extends Exception{
    ...
    public static function fromObjectMessage($message, $code, $previous = null){
        ...
        if(is_array($message)){
            ...
            return new EzlinkException( new Exception(implode("\n", $newMessageString), $code, $previous) );     
        }
        
        if(is_string($message)){
            
            return new EzlinkException( new Exception($message, $code, $previous) );     
    ...
    public static function fromGuzzleException(ServerException|ClientException|BadResponseException|RequestException $ex){
        ...
        return new EzlinkException( new \Exception($responseBody, $ex->getCode(), $ex->getPrevious()) );
    }
